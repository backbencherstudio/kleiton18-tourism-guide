...
import badge from "@/public/dashboard/icon/badge.png"

interface MakeFeaturedProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
}

export default function MakeFeatured({ isOpen, onClose, onConfirm }: MakeFeaturedProps) {
          ...
          <div className="self-stretch flex flex-col justify-start items-center gap-10">
            <div className="self-stretch flex flex-col justify-start items-center gap-10">
              <div className="w-[413px] text-center text-white text-2xl font-medium font-['Montserrat'] leading-[31.20px] tracking-tight">
                Are you sure you want to featured this profile?
              </div>
