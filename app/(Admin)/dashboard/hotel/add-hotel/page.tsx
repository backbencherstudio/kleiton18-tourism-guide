...
function Page() {
  ...
  return (
    <div className="flex flex-col gap-6 h-svh md:h-screen   2xl:max-h-[calc(100vh-100px)] border border-[#E2E8F0] shadow-[0px_-0.3px_5.5px_0px_rgba(0,0,0,0.02)] rounded-[12px] p-5 bg-white w-full">
      <div>
              ...
              return (
                <div key={index} className="flex items-center gap-1">
                  {!isLast ? (
                    ...
                    <span className="capitalize text-[#737373] font-medium">{path.split("-").join(" ")}</span>
                  )}
                </div>
              );
            })}
